...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    if ([WordGenerator sharedInstance].isDownloadDone) {
        return [[WordGenerator sharedInstance].jsonArray count];
    }
    else
    return 0;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    if ([WordGenerator sharedInstance].isDownloadDone) {
        cell.textLabel.text = [[[WordGenerator sharedInstance].jsonArray objectAtIndex:indexPath.row] objectForKey:@"Word"];
    }
